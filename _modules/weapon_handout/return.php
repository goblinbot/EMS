  ...
  <div class="container">
    ...
    <div class="main-row">
      ...
      <form id="returnGear" name="returnGear" action="return.php?ref=form&amp;co=<?=$barcode?>" method="post">
        ...
        <div class="row">
          <input type="text" class="textinput" style="max-width:25rem;" name="returnGear[barcode]" value="<?=$barcode?>" placeholder="A451E" required="required" max="10" />
        </div>
        ...
        <div class="row">
          ...
          <input type="submit" name="returnGear[submit]" value="Return gear to inventory." class="button button-default">
        </div>
